...
receive
    ...
    {request, From, Ref, Msg} ->
        NewMaxPrp = seq:increment(seq:maxfirst(MaxPrp, MaxAgr)), %% TODO: COMPLETE  If these two lines are not added the problem was that the sequencer was recieving messages  in different order due to the random jitter.
